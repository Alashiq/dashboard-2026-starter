...
export default {
    ...
    methods: {
        ...
        loadData: function (page) {
            ...
            this.$http
                .GetAllHalls(this.pageId, this.countPerPage, this.nameSrh)
                .then(response => {
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.$alert.Empty(
                                    "لم تعد هذه القاعة متوفرة, قد يكون شخص أخر قام بحذفه"
                                );
                            }
                        })
                        .catch(error => {
        ...
        disActiveHall: function (id, index) {
            Swal.fire({
                title: "هل أنت متأكد",
                    ...
                    this.$http
                        ...
                        .then(response => {
                            ...
                            if (response.status == 200) {
                                ...
                                this.mainList.splice(this.mainList.findIndex(m => m.id === id), 1);
                                this.$alert.Empty(
                                    "لم تعد هذه القاعة متوفرة, قد يكون شخص أخر قام بحذفها"
                                );
                            }
                        })
                        .catch(error => {
